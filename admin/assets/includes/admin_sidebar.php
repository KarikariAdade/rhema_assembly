                ...
                <aside class="app-navbar">
                    ...
                    <div class="sidebar-nav scrollbar scroll_light">
                        <ul class="metismenu " id="sidebarNav">
                           ...
                           <!--  <li><a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="nav-icon ti ti-calendar"></i><span class="nav-title">Events Calendar</span></a>
                            ...
                            <li class="sidebar-banner p-4 bg-gradient text-center m-3 d-block rounded">
                                <h5 class="text-white mb-1">Made By Karikari</h5>
                                <p class="font-13 text-white line-20">CEO of BizTech</p>
                                <a class="btn btn-square btn-inverse-light btn-xs d-inline-block mt-2 mb-0" href="#">juniorlecrae@gmail.com</a>
                            </li>
                        </ul>
                    </div>
                    <!-- end sidebar-nav -->
