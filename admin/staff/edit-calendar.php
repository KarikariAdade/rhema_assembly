              ...
              <div class="body">
                ...
                if (mysqli_num_rows($event_query) > 0) {
                  ...
                  <tr>
                    ...
                    <td><button class="btn btn-xs btn-primary"><a href="edit-event.php?event=<?php echo urlencode($event_id); ?>&activity=<?php echo urlencode($activity); ?>"><span class="fa fa-edit" style="color: #fff;"></span></a></button>
                      <form method="POST" action="includes/delete-event.php" class="pull-right">
                                          <input type="hidden" name="event_picture" value="<?php echo $event_picture; ?>">
                                          <input type="hidden" name="event_id" value="<?php echo $event_id; ?>">
                                       <button class="btn btn-xs btn-danger" name="delete_event_btn" onclick="return confirm('Are you sure you want to delete this event?. Deleted events cannot be recovered')"><span class="fa fa-trash"></span></button>
                                      </form>
                    </td>
                  </tr>
                  <?php
