    ...
    <section class="sidebar">
      ...
      $('#generate').click(function (e){
        ...
        <li class="header">FINANCE</li>
         <li>
          <a href="transactions.php">
            <i class="fa fa-donate"></i> <span> Transactions</span>
            <!-- <span class="pull-right-container">
              <small class="label pull-right bg-green">New</small>
            </span> -->
          </a>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li id="weekly-give"><a href="weekly-givings.php"><i class="fa fa-arrow-right fa-sm"></i> Weekly Tithes/Offering</a></li>
        ...
        <li>
          <a href="financial-report.php">
            <i class="fa fa-piggy-bank"></i> <span> Financial Report</span>
            <!-- <span class="pull-right-container">
              <small class="label pull-right bg-green">New</small>
            </span> -->
          </a>
