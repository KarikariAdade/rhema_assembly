       ...
       <?php if (!isset($_SESSION['id'])):?>
        ...
        <?php else:?>
          ...
          <head>
            ...
            <title>
              <div align="center" class="header_shit">
                <h3>The Church of Pentecost, Agona Rhema Assembly<br>
                Sunday Service Schedule for <?php echo date('F Y') ?></h3>
            </div>
            </title>
            <style type="text/css">
               @media print{
                ...
                <div class="table-responsive">
                  <table class="table table-bordered table-striped table-hover dataTable js-exportable" style="margin-top: 2%!important;">
                   ...
                   <tbody>
                    <?php
                    $this_month = date('F');
                    $fetch_act = "SELECT * FROM monthly_activities WHERE month_name = '$this_month' ORDER BY week_number ASC";
                  ...
                  echo "<h2>No activity has been scheduled for this month yet. ";
                  if ($position == "Presiding Elder") {
                    echo "<br> Make a schedule <a href='add-monthly-activity.php'>here</a><h2>";
                  }
                 }
                     ?>
                   </tbody>
