            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  <tbody>
                    <?php
                    $inbox_sql = "SELECT * FROM messages WHERE sender_email = '$user_email' AND sender_name = '$full_name' AND trash_status = 'No'";
                  ...
                  <?php
                      ...
                      echo "<p align='center'>There are no sent messages at the moment.</p>";
                    }
                  ?>
                  </tbody>
                </table>
