       ...
       <?php if (!isset($_SESSION['id'])):?>
        ...
        <?php else:?>
          ...
          <head>
            ...
            <title>Rhema Assembly | Church Members</title>
                 ...
                 <tbody>
                  ...
                  if (mysqli_num_rows($query) > 0) {
                    while ($row = mysqli_fetch_assoc($query)) {
                     ...
                     <td><a href="member-detail.php?member=<?php echo urlencode($member_id);?>&slug=<?php echo urlencode($last_name);?>&user=<?php echo urlencode($first_name);?>"><?php echo time_ago($year_duration); ?></a></td>
                     ...
                     <td><a href="member-detail.php?member=<?php echo urlencode($member_id);?>&slug=<?php echo urlencode($last_name);?>&user=<?php echo urlencode($first_name);?>"><?php echo $home_cell_group; ?></a></td>
                     <td><a href="member-detail.php?member=<?php echo urlencode($member_id);?>&slug=<?php echo urlencode($last_name);?>&user=<?php echo urlencode($first_name);?>"><?php echo $bible_study_group; ?></a></td>
                   </tr>
                  <?php
                }
              }else{
