    ...
    <div class="blog-sidebar col col-lg-4 col-md-4 col-md-pull-8 col-sm-5">
       <!--  <div class="widget search-widget">
        ...
        <div class="widget recent-post-widget">
           ...
           <h3>Pentecost Podcast</h3>
            <p align="center">
                      <a href="https://podcasts.apple.com/gh/podcast/church-pentecost-headquarters/id945762266?mt=2">
                        <img src="img/podcast.jpg" class="img-fluid" style="width:90%;">
                      </a>
                    </p>
           <h3>Recent News</h3>
           <div class="themeDesc">
                    ...
                    if (mysqli_num_rows($event_query) > 0) {
                        while ($row = mysqli_fetch_assoc($event_query)) {
                           ...
                           <div class="card">
                            ...
                            <div class="card-body">
                                <div>
                                    <h5><a href="church?news=<?php echo $news_slug; ?>"><?php echo $news_title; ?></a></h5>
                                    <p style="color: #fff !important; position: relative;z-index: 60 !important;"><?php echo $news_description; ?></p>
                                </div>
                            </div>
                        </div>
                        <?php
  ...
  // FETCH NUMBER OF POSTS UNDER ARCHIVE
                ...
                ?>
                <?php
                echo "<li><a id='archive' href='newsarchive?month=$month&year=$year'>".$monthName." <span class='badge' id='archive_counter'>".$archive_counter."</span></a></li>";
                ?>
                <?php
            }
        }
