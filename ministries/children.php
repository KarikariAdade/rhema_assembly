...
$event_sql = "SELECT * FROM events WHERE event_category = 'Children Ministry' ORDER BY id DESC LIMIT 6";
              $event_query = mysqli_query($conn, $event_sql);
              $child_event_counter = mysqli_num_rows($event_query);
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<div class="container-fluid board_intro_pic_3">
		<img src="img/children.jpg" style="width: 100%;">
	...
	<div class="container children_intro">
		<div class="row">
			<div class="col-md-6">
				<h1>BIZZLE TECH</h1>
				<p>Deuteronomy 6:5-7 is a directive to parents about being the spiritual leaders of their homes. Our New Vision Preschool & Kindergarten Ministries want to help you succeed! We are committed to partnering with you, the parents, to sow seeds of faith and lay a strong biblical foundation in your child’s life.</p>
			</div>
			<div class="col-md-6">
				<div class="">
	...
	<div class="container-fluid children_hero">
		<div class="children_hero_desc">
		<h2>RHEMA CHILDREN</h2>
		<h5>We don't babysit our children...we engage them in Bible study, praises and worship!</h5>
		<p>
			We want your child to love coming to church! Rhema Assembly's Children Ministry provides a safe, secure, loving environment where preschoolers learn about God and His love at their level of understanding. We aren’t babysitting! Children learn by “doing” so our curriculum allows them to engage in developmentally appropriate hands-on learning activities that correlate with a Bible story. When you see them interacting in their learning centers, they aren't just "playing", they are learning to make the connection between the Bible and everyday life. We have faithful leaders who are passionate about teaching and modeling the love of God to your child. 
<br><br>
For more information, email <a href="mailto:juniorlecrae@gmail.com">Karikari Adade.</a> We're looking forward to meeting you!
		</p>
	</div>
	</div>
	<div class="container children_events">
    <?php if ($child_event_counter > 0):?>
...
<?php endif;?>
    ...
    <div class="col-md-8">
      <h5>See our Staff: <span> CHILDREN MINISTRY TEAM</span></h5>
    </div>
    <div class="col-md-4">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="team-member">
                    <div class="team-thumb">
                        <img src="img/member_pic.jpg" alt="" style="height: 40vh;" />
