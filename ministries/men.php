<?php
 include '../includes/connect.php';
  $event_sql = "SELECT * FROM events WHERE event_category = 'Men Ministry' ORDER BY id DESC LIMIT 6";
  $event_query = mysqli_query($conn, $event_sql); 
  $men_event_counter = mysqli_num_rows($event_query);
 ?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<div class="container-fluid board_intro_pic_3">
		<img src="img/men.jpg" style="width: 100%;">
	...
	<div class="container themeDesc">
		<div class="row">
			<div class="col-md-8">
				<p>The Men's Ministry caters for all men in the church. The Men's Ministry organises serminars,workshops etc on all aspects of including Marriage enrichment, husband's responsibilities in the Church and the current affairs at both National and International levels</p>

				<h2>Vision</h2>
				<p>To become an effective and significant to passionately reach MenforChrist in partnership with the Church</p>

				<h2>Mission</h2>
				<p>A total Christian Man who is committed, spirit-filled and strong in Christ character to positively impact the family, the Church and the community</p>
			</div>
			<div class="col-md-4">
...
<?php endif;?>
    ...
    <div class="col-md-8">
      <h5>See our Staff: <span> MEN'S MINISTRY TEAM</span></h5>
    </div>
    <div class="col-md-4">
