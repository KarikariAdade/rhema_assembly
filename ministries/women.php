<?php
 include '../includes/connect.php';
  $event_sql = "SELECT * FROM events WHERE event_category = 'Women Ministry' ORDER BY id DESC LIMIT 6";
  $event_query = mysqli_query($conn, $event_sql); 
  $women_event_counter = mysqli_num_rows($event_query);
 ?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<div class="container-fluid board_intro_pic_3">
		<img src="img/women.jpg" style="width: 100%;">
	...
	<div class="container themeDesc">
		<div class="row">
			<div class="col-md-8">
				<p>Besides a core function of praying for the Church, the Women's Ministry, which embraces all the women, is responsible forgiving employable and vocational skills, and training in home management to women. The meet on Tuesdays <br>
				The Women's Ministry organises retreats, seminars etc in all aspects of life including enrichment, wives' responsibilities at home, child welfare and education ets.<br>
				It also carries out evangelism, counselling and sponsorship activities to help the needy in the church and in the society.
				
				</p>

				<h2>Vision</h2>
				<p>To become an effective and significant to passionately reach Women for Christ in partnership with the Church</p>

				<h2>Mission</h2>
				<p>A total Christian woman who is committed, spirit-filled and strong in Christ character to positively impact the family, the Church and the community</p>
			</div>
			<div class="col-md-4">
	...
	<div class="team-section">
		<div class="container">
			<div class="row plug_in" style="padding-bottom: 2%;">
				<div class="col-md-8">
					<h5>See our Staff: <span> WOMEN'S MINISTRY TEAM</span></h5>
				</div>
				<div class="col-md-4">
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="team-member">
						<div class="team-thumb">
							<img src="img/service/woman_sing.jpg" alt="" style="height: 40vh;" />
