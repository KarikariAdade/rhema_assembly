...
$event_sql = "SELECT * FROM events WHERE event_category = 'Youth Ministry' ORDER BY id DESC LIMIT 6";
$event_query = mysqli_query($conn, $event_sql); 
$youth_event_counter = mysqli_num_rows($event_query);
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<div class="container-fluid board_intro_pic_3">
		<img src="img/youth.jpg" style="width: 100%;">
	...
	<div class="team-section">
		<div class="container">
			<div class="row plug_in" style="padding-bottom: 2%;">
				<div class="col-md-8">
					<h5>See our Staff: <span> YOUTH MINISTRY TEAM</span></h5>
				</div>
				<div class="col-md-4">
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="team-member">
						<div class="team-thumb">
							<img src="img/service/nii_pray.jpg" alt="" style="height: 40vh;" />
