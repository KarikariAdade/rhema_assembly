...
?>
 <?php if (!isset($_SESSION['id'])):?>
 	...
 	<?php else:?>
    <?php
    $task_user_id = $_GET['task'];
    if (!isset($_GET['task'])) {
      echo "<script>window.location = 'add-task.php';</script>";
    }
    ?>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
  	<div class="wrapper">
        ...
        <?php
        $sql = "SELECT * FROM tasklist WHERE task_title='$task_user_id'";
          ...
          <div class="row">
            <div class="col-md-7">
              ...
              <div class="add_profile_container" style="background-color: #fff; padding:20px !important;">
                ...
                <form role="form" class="row edit_task_form" method="POST" action="edit-task.php" enctype="multipart/form-data">
                  ...
                  <div class="box-body col-md-6">
                    ...
                    <div class="input-group credential_form">
                      ...
                      <input type="text" class="form-control" name="task_title" id="task_title" value="<?php echo $task_title; ?>">
                    </div>
                  </div>
                  <div class="box-body col-md-6">
                    ...
                    <div class="input-group credential_form">
                      ...
                      <input type="date" class="form-control" name="task_title" id="task_schedule_date" value="<?php echo $task_date; ?>">
                    </div>
                  </div>
                  <div class="box-body col-md-6">
                    ...
                    <div class="input-group credential_form">
                      ...
                      <input type="time" class="form-control" name="task_title" id="task_schedule_time" value="<?php echo $task_time;?>">
                    </div>
                  </div>
                  <div class="box-body col-md-6">
                    ...
                    <div class="form-group credential_form">
                      <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" id="task_status" name="task_status">
                        <option selected="selected"><?php echo $task_status; ?></option>
                  ...
                  <div class="box-body col-md-6">
                    <label>Task Status</label>
                    <div class="form-group credential_form">
                      <select class="form-control select select-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" id="task_marker" name="task_marker">
                        <option selected="selected"><?php echo $task_marker; ?></option>
                  ...
                  <div class="box-body col-md-12">
                    <div class="form-group credential_form">
                      ...
                      <textarea class="form-control" rows="10" placeholder="Please write something about the task" name="task_description" id="task_description"><?php echo $task_description; ?></textarea>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4" style="padding-bottom: 3%;">
                    <button type="submit" class="btn btn-primary" name="edit_task_btn" id="edit_task_btn">Submit</button>
                  </div>
                </form>
              </div>
            </div>
...
<script type="text/javascript">
  $(document).ready(function (){
    $('.edit_task_form').submit(function (event){
      ...
      var task_marker = $('#task_marker').val();
      var edit_task_btn = $('#edit_task_btn').val();
      $('#formError').load('includes/edit-task.php?task=<?php echo urlencode($task_user_id); ?>',{
        task_id: task_id,
        user_id: user_id,
