            ...
            <div class="card">
              <div class="body">
                <div class="table-responsive">
                 ...
                 <tbody>
                  <?php
                  $sql = "SELECT id, full_name, email, address, phone, company, event FROM volunteers WHERE event='Crusade' OR event = 'Sunday Service' OR event = 'Camp Meetings' OR event = 'Visitations' OR event = 'Evangelism' OR event = 'General Events'";
                  ...
                  if (mysqli_num_rows($query) > 0) {
                    while ($row = mysqli_fetch_assoc($query)) {
                     ...
                     <td>
                      <a href="volunteer-detail.php?volunteer=<?php echo urlencode($volunteer_id);?>&slug=<?php echo urlencode($company);?>&user=<?php echo urlencode($full_name);?>"><?php echo $event; ?></a>
                    </td>
                   </tr>
                  <?php
                }
