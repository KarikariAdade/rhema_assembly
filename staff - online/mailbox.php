            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  <tbody>
                    <?php
                    $inbox_sql = "SELECT * FROM messages WHERE receiver_email = '$user_email' AND trash_status = 'No' ORDER BY id DESC";
                  ...
                  <tr>
                    <td>
                      <form method="POST" action="includes/trash-mail.php">
                        <input type="hidden" name="trash_id" value="<?php echo $message_id; ?>">
                      <button type="submit" onclick="return confirm('Are you sure you want to move this message to trash bin?')" name="mail-trash-btn" style="background-color: transparent;border:none;" class="btn btn-xs btn-danger"><span style="color:#dd4b39;" class="fa fa-trash"></span></button>
                    </form></td>
                    <td class="mailbox-name"><a href="mail-detail.php?message=<?php echo urlencode($message_id); ?>&slug=<?php echo urlencode($message_title); ?>"><?php echo $sender_name; ?></a></td>
