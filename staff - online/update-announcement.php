 ...
 <?php if (!isset($_SESSION['id'])):?>
  ...
  // FETCH NUMBER OF POSTS UNDER ARCHIVE
      ...
      ?>
              ...
              $sql = "SELECT * FROM announcement WHERE announcement_slug = '$announcement'";
              $query = mysqli_query($conn, $sql);
              if (mysqli_num_rows($query) > 0) {
                while ($row = mysqli_fetch_assoc($query)) {
...
if (isset($_POST['announcement_update_btn'])) {
  ...
  $del_image = mysqli_real_escape_string($conn, $_POST['del_image']);
...
?>
  						<div class="col-md-9">
  							<form class="row" method="POST" action="" enctype="multipart/form-data">
  								<?php if(isset($_POST['announcement_update_btn'])): ?>
  									<p id="formError" style="margin-top: -40px !important;"><?php echo $errorMsg; ?></p>
  									<?php endif?><br>
  									<div class="col-md-6">
                      <input type="hidden" name="id" value="<?php echo $id; ?>">
                      <input type="hidden" name="del_image" value="<?php echo $image; ?>">
  										...
  										<div class="input-group credential_form">
  											...
  											<input type="text" class="form-control" name="announcement_title" value="<?php echo $announcement_title; ?>" />
  										</div>
  									</div>
  									<div class="col-md-6">
  										...
  										<div class="input-group credential_form">
  											...
  											<input type="text" class="form-control" name="publisher_name" value="<?php echo $publisher_name; ?>" />
  										</div>
  									</div>
  									<div class="col-md-6">
                          ...
                          <option>General Announcement</option>
  									...
  									<div class="col-lg-12 col-sm-12">
  										<div class="body" align="left">
  											<textarea class="summernote form-control no-resize" type="text" name="announcement_description" id="announcement_description" style="resize: none !important;">
                          <?php echo $description; ?>
  											</textarea>
  										</div>
  									</div>
  									<div class="col-md-12" align="center">
  										<button class="btn btn-success" type="submit" name="announcement_update_btn">Update Announcement</button>
  									</div>
  								</form>
