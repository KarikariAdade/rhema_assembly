  	...
  	<div class="wrapper">
  		...
  		<div class="content-wrapper">
  			...
  			<div class="container" style="margin-top: 5%;">
                ...
                $sql = "SELECT * FROM news ORDER BY id DESC LIMIT $start_from, $record_per_page";
                $query = mysqli_query($conn,$sql);
                if (mysqli_num_rows($query) > 0) {
                  while ($row = mysqli_fetch_assoc($query)) {
                    $id = $row['id'];
                  ...
                  echo "<h2>There are no posts yet.</h2>";
                }
                  ...
                  <p align="center">
                    <?php if(mysqli_num_rows($query) > 1): ?>
                      ...
                      for ($i=1; $i<=$total_pages; $i++) { 
                        echo "<a class='pagination' href='view-news.php?page=".$i."'>".$i."</a>";
                      }
                      ?>
                    <?php endif;?>
                  </p>
